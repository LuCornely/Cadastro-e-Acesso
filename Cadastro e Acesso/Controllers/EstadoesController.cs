...
namespace Cadastro_e_Acesso.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public EstadoesController(CadastroeAcessoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeEstado,UnidadeFederativa")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeEstado,UnidadeFederativa")] Estado estado)
        {
            if (id != estado.Id)
            {
                return NotFound();
